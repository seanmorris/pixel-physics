...
var EggMobile = /*#__PURE__*/function (_PointActor) {
  ...
  function EggMobile() {
    ...
    _this.args.xSpeedMax = 10;
    _this.args.ySpeedMax = 10;
    _this.args.jumpForce = 12;
    _this.args.gravity = 0.6;
    _this.args.width = 54;
    _this.args.height = 20;
    _this.args["float"] = -1;
    _this.args.yMargin = 32;
...
var PointActor = /*#__PURE__*/function (_View) {
  ...
  _createClass(PointActor, [{
    ...
    value: function updateAirPosition() {
      ...
      this.willJump = false;
      var blockers = false;
      var upMargin = this.args.flying ? this.args.height + this.args.yMargin : 0;
    ...
    value: function processInput() {
      if (this.standingOn && this.standingOn.isVehicle) {
        ...
        var seatX = (vehicle.args.seatX || 0) * this.args.direction;
        var seatY = vehicle.args.seatY || 0;
        this.args.x = vehicle.args.x + seatX; // this.args.y = vehicle.args.y + vehicle.args.height + seatY;
      } else {
