...
var MainMenu = /*#__PURE__*/function (_Card) {
  ...
  function MainMenu(args, parent) {
    ...
    _this.args.items = ['item 1', 'item 2'];
...
module.exports = "<div class = \"screen-card screen-card-[[cardName]] [[animation]]\">\n\t<div class = \"menu-scroller\"></div>\n\t<div class = \"menu-container\">\n\t\t<div>Sonic 3000</div>\n\t\t<ul cv-ref = \"bound\">\n\t\t\t<li cv-on = \"click:remove()\" tabindex=\"0\">Single Player</li>\n\t\t\t<li class = \"unavailable\" tabindex=\"0\">Connnect to Server</li>\n\t\t\t<li class = \"unavailable\" tabindex=\"0\">Direct Connect</li>\n\t\t\t<li class = \"unavailable\" tabindex=\"0\">Options</li>\n\t\t\t<!-- <li tabindex=\"0\">Exit</li> -->\n\t\t</ul>\n\t</div>\n\t[[warp]]\n</div>\n\n\n"
});
  ...
  function Viewport(args, parent) {
    ...
    _this.listen(document, 'keydown', function (event) {
      if (event.key === 'F10') {
        ...
        _this.args.showConsole = !_this.args.showConsole;
        event.preventDefault();
      }
    });
      ...
      if (this.controlActor) {
        ...
        for (var i in this.actors.list) {
          ...
          if (!this.auras.has(_actor2)) {
            ...
            } else if (_actor2.vizi && (offscreenX > 800 || offscreenY > 800)) {
              _actor2.sleep();
