...
var MainMenu = /*#__PURE__*/function (_Card) {
  ...
  _createClass(MainMenu, [{
    ...
    value: function onRendered() {
      ...
      this.listen(bounds, 'focus', function (event) {
        return _this2.currentItem = event.target;
      });
      this.listen(bounds, 'blur', function (event) {
    ...
    value: function answer() {
      ...
      answer.then(function (token) {
        ...
        _this5.args.hostOutput = encodedToken;
        _this5.args.haveToken = true;
      });
      return answer;
    }
  }, {
    ...
    value: function paste(event) {
      ...
      navigator.clipboard.readText().then(function (copied) {
        if (_this6.args.hostGame && copied.match(/^s3ktp:\/\/request\//)) {
          _this6.args.input = copied;

          _this6.answer().then(function (token) {
            _this6.copy();
          });
        }

        if (_this6.args.joinGame && copied.match(/^s3ktp:\/\/accept\//)) {
          _this6.args.input = copied;
    ...
    value: function refreshConnection() {
      ...
      var onOpen = function onOpen(event) {
        _this7.parent.args.networked = true;
...
var ChatBox = /*#__PURE__*/function (_View) {
  ...
  function ChatBox(args, parent) {
    ...
    var onMessage = function onMessage(event) {
      _this.args.outputLines.push("> ".concat(event.detail));

      _this.onNextFrame(function () {
        _this.tags.chatOutput && _this.tags.chatOutput.scrollTo(0, _this.tags.chatOutput.scrollHeight);
      });
    };
    ...
    value: function play(event) {
      ...
      return new Promise(function (accept) {
        ...
        if (!_this2.args.waitFor) {
          ...
          _this2.args.waitFor["finally"](finishPlaying);
        }
      });
    }
  }]);
...
var Viewport = /*#__PURE__*/function (_View) {
  ...
  function Viewport(args, parent) {
    ...
    _this.args.titlecard = new _Series.Series({
      cards: [new _LoadingCard.LoadingCard({
        timeout: 350,
        text: 'loading'
      }, _assertThisInitialized(_this)) // , new BootCard({timeout: 2500})
      , new _SeanCard.SeanCard({
        timeout: 5000
      }, _assertThisInitialized(_this)), new _TitleScreenCard.TitleScreenCard({
        timeout: 50000,
        waitFor: ready
      }, _assertThisInitialized(_this)), new _MainMenu.MainMenu({
        timeout: -1
      }, _assertThisInitialized(_this)), new _Titlecard.Titlecard({
  ...
  _createClass(Viewport, [{
    ...
    value: function onAttached(event) {
      ...
      this.args.titlecard.play().then(function (done) {
        return _this4.onNextFrame(function () {
          return _this4.startLevel();
        });
      });
    ...
    value: function startLevel() {
      ...
      this.tileMap.ready.then(function () {
        if (!_this5.args.populated && !_this5.args.networked) {
          _this5.populateMap();
        }
      });
    }
    ...
    value: function getServer() {
      ...
      var onOpen = function onOpen(event) {
        return _this7.args.chatBox = new _ChatBox.ChatBox({
          pipe: server
        });
      };
    ...
    value: function getClient() {
      ...
      var onOpen = function onOpen(event) {
        return _this8.args.chatBox = new _ChatBox.ChatBox({
          pipe: client
        });
      };
