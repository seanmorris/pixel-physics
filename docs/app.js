...
var Sonic = /*#__PURE__*/function (_PointActor) {
  ...
  _createClass(Sonic, [{
    ...
    value: function onAttached() {
      this.box = this.findTag('div');
      this.sprite = this.findTag('div.sprite'); // this.twister = new Pinch;

      this.twister = new _Twist.Twist();
      this.viewport.effects.add(this.twister);
      this.args.fgFilter = "url(#twist)";
      this.args.bgFilter = "url(#twist)"; // this.twister.listen('attached', () => , {once:true});
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Promise.all([viewportA.tileMap.ready, replay]).then(function (_ref) {
    ...
    if (replay.length) {
      viewportA.args.hasRecording = true; // viewportA.args.isReplaying  = true;
    }
